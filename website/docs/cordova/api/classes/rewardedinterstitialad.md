...
- [`MobileAd`](MobileAd)<[`RewardedInterstitialAdOptions`](../interfaces/RewardedInterstitialAdOptions)\>
...
| Name | Type |
| :------ | :------ |
| `opts` | [`RewardedInterstitialAdOptions`](../interfaces/RewardedInterstitialAdOptions) |
...
• `Protected` `Readonly` **opts**: [`RewardedInterstitialAdOptions`](../interfaces/RewardedInterstitialAdOptions)
...
code/github/admob-plus/packages/cordova/ts/rewarded-interstitial.ts:9
...
code/github/admob-plus/packages/cordova/ts/rewarded-interstitial.ts:13
...
code/github/admob-plus/packages/cordova/ts/rewarded-interstitial.ts:17
