...
For Android developer, `com.google.android.gms:play-services-ads:$PLAY_SERVICES_VERSION` is is available for configuration, the default is `--PLAY_SERVICES_VERSION=16.0.0`.
