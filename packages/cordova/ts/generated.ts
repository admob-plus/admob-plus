...
export enum NativeActions {
  ...
  bannerDestroy = 'bannerDestroy',
  canvasBannerConfig = 'canvasBannerConfig',
  canvasBannerHide = 'canvasBannerHide',
  canvasBannerLoad = 'canvasBannerLoad',
  canvasBannerShow = 'canvasBannerShow',
  canvasBannerDestroy = 'canvasBannerDestroy',
  canvasBannerGetAdViewImage = 'canvasBannerGetAdViewImage',
  canvasBannerSimulateClickEvent = 'canvasBannerSimulateClickEvent',
...
export enum Events {
  ...
  canvasBannerClick = 'admob.canvasbanner.click',
  canvasBannerClose = 'admob.canvasbanner.close',
  canvasBannerImpression = 'admob.canvasbanner.impression',
  canvasBannerLoad = 'admob.canvasbanner.load',
  canvasBannerLoadFail = 'admob.canvasbanner.loadfail',
  canvasBannerOpen = 'admob.canvasbanner.open',
  canvasBannerSize = 'admob.canvasbanner.size',
  canvasBannerSizeChange = 'admob.canvasbanner.sizechange',
