...
admob-plus/1.0.0-alpha.0 darwin-x64 node-v15.6.0
...
_See code: [src/commands/info.ts](https://github.com/admob-plus/admob-plus/blob/v1.0.0-alpha.0/src/commands/info.ts)_
<!-- commandsstop -->
